...
# We have already defined the above functionality in the calculator utils. We are calling the various functions above to create the tools that can be used in the agent.
# The tools are then used in the agent to perform the calculations.